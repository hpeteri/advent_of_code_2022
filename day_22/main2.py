...
try:
    ...
    print(f"failed to open file: 'test_input.txt")
    sys.exit()
...
for i in range(cube_diameter):
    ...
    # 0
    cube_map[0].append(grid[i][2 * cube_diameter: 3 * cube_diameter])

    #1
    cube_map[1].append(grid[cube_diameter + i][: cube_diameter])

    #2
    cube_map[2].append(grid[cube_diameter + i][cube_diameter: cube_diameter * 2])

    #3
    cube_map[3].append(grid[cube_diameter + i][cube_diameter * 2: cube_diameter * 3])
    
    #4
    cube_map[4].append(grid[cube_diameter * 2 + i][cube_diameter * 2: cube_diameter * 3])

    #5
    cube_map[5].append(grid[cube_diameter * 2 + i][cube_diameter * 3: cube_diameter * 4])                   
    ...
    if instruction.isdigit():
        ...
        for i in range(int(instruction)):
            ...
            while 1:
                ...
                elif x == cube_diameter:
                    # print("x == dim, change side")
                    # facing idx == 0
